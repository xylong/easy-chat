...
var file_apps_im_rpc_im_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x69, 0x6d, 0x22, 0x1d, 0x0a, 0x07, 0x52, 0x65,
	...
	0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x6f, 0x6e, 0x67, 0x32, 0x27, 0x0a, 0x02, 0x49, 0x6d, 0x12,
	0x21, 0x0a, 0x04, 0x50, 0x69, 0x6e, 0x67, 0x12, 0x0b, 0x2e, 0x69, 0x6d, 0x2e, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x0c, 0x2e, 0x69, 0x6d, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x42, 0x06, 0x5a, 0x04, 0x2e, 0x2f, 0x69, 0x6d, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_apps_im_rpc_im_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_apps_im_rpc_im_proto_goTypes = []any{
	(*Request)(nil),  // 0: im.Request
	(*Response)(nil), // 1: im.Response
}
var file_apps_im_rpc_im_proto_depIdxs = []int32{
	0, // 0: im.Im.Ping:input_type -> im.Request
	1, // 1: im.Im.Ping:output_type -> im.Response
...
func file_apps_im_rpc_im_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_apps_im_rpc_im_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_apps_im_rpc_im_proto_msgTypes[1].Exporter = func(v any, i int) any {
